  ...
  return (
    <>
      <div className="flex relative w-[81px] h-[30px]">
        ...
        <img src={Usericon2} alt="" className="h-[30px] w-[30px] absolute left-[17px]" />
        <img src={Usericon3} alt="" className="h-[30px] w-[30px] absolute left-[34px]" />
        <img src={Usericon4} alt="" className="h-[30px] w-[30px] absolute left-[51px]" />
      </div>
    </>
  );
};
