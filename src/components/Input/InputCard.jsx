...
function InputCard({ text,value, placeholder,type="text",onChange }) {
  return (
    <div className="bg-gray-300 pb-[20px]">
      ...
      <div className="flex justify-between items-center py-3 pr-4 pl-5 bg-white rounded-md">
        <input type={type} value={value} onChange={onChange} placeholder={placeholder} className="w-[400px] border-none outline-none" />
